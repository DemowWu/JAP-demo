 ...
 * @author hq.W
 * @program JAP-demo
 * @description Oauth2implicitController
 */
public class Oauth2ImplicitController extends Controller {
 ...
 * <br>
 * implicit模式，token直接从URL参数中获取。在AccessTokenHelper类中，判断授权类型GrantType = token，调用getAccessTokenOfImplicitMode，从请求参数中获取request.getParameter("access_token")等参数信息,最终并返回AccessToken对象
 *
 */
    @ActionKey("/oauth2Implicit")
    public void renderAuth(){
        ...
        config.setPlatform("gitee")
                ...
                .setCallbackUrl("http://127.0.0.1:8091/oauth2Implicit")
