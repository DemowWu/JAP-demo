    ...
    <div class="cardContainer">
      <el-card class="mycard animate__animated animate__fadeInBottomRight"  shadow="always">
        <div slot="header" class="clearfix">
          <span style="margin-top: 20px;font-size: 20px">ActFramework</span>
                ...
                <div slot="title">
                  ...
                  <el-divider>
                    <el-tag type="primary" style="height: 35px; width: 130px; text-align: center; font-size: medium;">
                      <el-link type="primary" href="https://github.com/actframework/actframework"><div class="animate__animated animate__fadeInUp">ActFramework</div></el-link>
                    </el-tag>
                  </el-divider>
...
<script>
    ...
    import {requestActframework} from "@/api/requestActframework";
  ...
  methods:{
    ...
    goOidcLogin(){
        if (this.userInfo.clientId == '' || this.userInfo.redirectURI == ''||this.userInfo.clientSecret == ''){
            ...
            return requestActframework({
                ...
                window.open(res.data.toAuth,"_self");
                console.log(res);
    ...
    goThirdLogin(){
        if (this.userInfo.clientId == '' || this.userInfo.redirectURI == ''||this.userInfo.clientSecret == ''){
            ...
            return requestActframework({
                ...
                // var toAuth = res.data.;
                console.log("japResponse：" + res.data.toAuth);
                console.log(res.data)
                window.location = res.data.toAuth;
    ...
    //  向后台发送待验证数据
      ...
      return requestActframework({
          ...
          .then(res =>{
          console.log("userInfos：" + res.data.userInfos);
          this.toShowUser(res.data.code,res.data.userInfos);
      }).catch(err=>{
          console.log(err);
      })
