    ...
    <div class="cardContainer">
      <el-card class="mycard animate__animated animate__fadeInBottomRight"  shadow="always">
        <div slot="header" class="clearfix">
          <span style="margin-top: 20px;font-size: 20px">Blade</span>
                ...
                <div slot="title">
                  ...
                  <el-divider>
                    <el-tag type="primary" style="height: 35px; width: 130px; text-align: center; font-size: medium;">
                      <el-link type="primary" href="https://gitee.com/biezhi/blade#blade%E6%98%AF%E4%BB%80%E4%B9%88"><div class="animate__animated animate__fadeInUp">Blade</div></el-link>
                    </el-tag>
                  </el-divider>
...
<script>
    ...
    import {requestBlade} from "@/api/requestBlade";
